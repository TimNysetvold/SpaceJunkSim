...
for iteration in range(0,5):
    ...
    distancesArray = np.delete(distancesArray,deletionIndices.astype(int),0)
    distancesArray = np.delete(distancesArray,deletionIndices.astype(int),1)
    
    #We must remove deleted items from the indexes that we're watching, or we'll throw off the indexing
    ...
    watchedIndexes = np.delete(watchedIndexes,watchedIndexesToDelete,axis=0)
